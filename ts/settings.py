...
DATABASES = {
    'default': {
        ...
        # 'HOST': '173.194.240.41', # local
        'HOST': '/cloudsql/google.com:townsquare:sql', #prod
        'NAME': 'speckle',
        'USER': 'root',
        # 'PASSWORD': 'root',
    },
...
SECRET_KEY = 'o98&u1flzj&n=l28#h=f(xsx0$c(c@1rojx50r7mmrzc=^m-*a'

# Keep this application-specific password secret!
# vrel sszw uuxl zkwb
