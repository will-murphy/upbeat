...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Activity.post'
        db.add_column(u'main_activity', 'post',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Post'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Activity.comment'
        db.alter_column(u'main_activity', 'comment_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Comment'], null=True))

    def backwards(self, orm):
        # Deleting field 'Activity.post'
        db.delete_column(u'main_activity', 'post_id')


        # Changing field 'Activity.comment'
        db.alter_column(u'main_activity', 'comment_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['main.Comment']))

    models = {
        u'main.activity': {
            'Meta': {'object_name': 'Activity'},
            'comment': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Comment']", 'null': 'True', 'blank': 'True'}),
